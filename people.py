...
edward = Player("Edward Elric")
al = Player("Alphonse Elric")
#yukko = Player("Yuuko Aioi") # underage, dont let her in
#mio = Player("Mio Naganohara") # underage, dont let her in
#mai = Player("Mai Minakami") # underage, dont let her in